  ...
  return (
    <div>
      ...
      <div>
        <input
          value={title}
          onChange={e => seTitle(e.currentTarget.value)}
...
export const UpdateTodolists = () => {
  ...
  const updateTodolist = () => {
    todolistsAPI.updateTodolist(title, todolistId).then(res => setState(res.data));
  };
  ...
  return (
    <div>
      ...
      <div>
        ...
        />
        <button type="button" onClick={updateTodolist}>
          Update todolist
        </button>
      </div>
    </div>
    ...
    <div>
      ...
      <div>
        <input
          ...
          placeholder="todolistId"
        />
        <button type="button" onClick={() => deleteTodolist(todolistId)}>
          Delete Todolist
        </button>
      </div>
    </div>
...
export const CreateTask = () => {
  ...
  useEffect(() => {
    ...
    const todolistId = '42818c70-de08-449a-988a-5e9ea8f7dd2f';
    todolistsAPI.createTask(newTitle, todolistId).then(res => setState(res.data));
  }, []);
...
export const UpdateTask = () => {
  ...
  useEffect(() => {
    ...
    todolistsAPI.updateTask(todolistId, taskId, body).then(res => setState(res.data));
  }, []);
