...
test('Todolist Reducer add Todolist', () => {
    ...
    let initState: TodoListDomenType[] = [{id: v1(), title: "What to learn", order: 0, addedDate: "", filter: "all", tlEntityStatus: "idle"}]
...
test('Todolist Reducer remove Todolist', () => {
    ...
    let initState: TodoListDomenType[] = [
        {id: v1(), title: "What to learn", order: 0, addedDate: "", filter: "all", tlEntityStatus: "idle"},
        {id: tdID, title: "What to bye", order: 0, addedDate: "", filter: "all", tlEntityStatus: "idle"}
    ]
...
test('Todolist tlEmptytyStatus  must be chenged correctly', () => {
    let initState: TodoListDomenType[] = [{id: "test_todo_id", title: "What to learn", order: 0, addedDate: "", filter: "all", tlEntityStatus: "idle"}]

    let newTodoList = TotoListReducer(initState, changeTodolistEntityStatusAC("test_todo_id", "loading"))
